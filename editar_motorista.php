...
<div class="container">
	...
	<form method="post" action="salvar_produto.php?id=<?= $p['id']; ?>">
		...
		<div class="form-group">
			<label>Veiculo:</label>
			<input type="text" name="veiculo" class="form-control" placeholder="Digite o modelo correto" value="<?= $p['veiculo']; ?>">
		</div>
		<div class="form-group">
			<label>Status:</label>
			<input type="text" name="situacao" class="form-control" placeholder="Digite o status correto" value="<?= $p['situacao']; ?>">
		</div>
		<div class="form-group">
			<label>SEXO:</label>
